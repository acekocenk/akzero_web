<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h3 align="center">Form Edit Material</h3>
    </div>
    <div class="card-body">
        <form action="javascript:void(0)" method="post" enctype="multipart/form-data" id="frmEditmaterial">
            <?= csrf_field(); ?>
            <input type="hidden" id="id" name="id" value="<?= $material['id']; ?>">
            <input type="hidden" id="slug" name="slug" value="<?= $material['slug']; ?>">
            <div class="row">
                <div class="col-lg-3">
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm text-uppercase" id="materialcode" name="materialcode" value="<?= $material['materialcode']; ?>" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm text-uppercase" id="materialname" name="materialname" value="<?= $material['materialname']; ?>">
...
<script type="text/javascript">
    ...
    function materialUpdate() {
        $('#frmEditmaterial').submit(function(e) {
            e.preventDefault();
            $.ajax({
                type: "post",
                url: "/material/update",
