<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h3 align="center">Form Edit Category</h3>
    </div>
    <div class="card-body">
        <form action="javascript:void(0)" method="post" enctype="multipart/form-data" id="frmEditCategory">
            <?= csrf_field(); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm text-uppercase" id="categorycode" name="categorycode" value="<?= $category['categorycode']; ?>" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm text-uppercase" id="categoryname" name="categoryname" value="<?= $category['categoryname']; ?>">
